...
class __TwigTemplate_ca89612d6b21bab956a53d3b653a8d28be10d15daef40ee56fc4eb001ec79ef0 extends Twig_Template
{
    ...
    <div class=\"col-lg-10\">
      ";
        ...
        // line 35
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_addons_connect.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 35)->display(array_merge($context, array("level" => (isset($context["level"]) ? $context["level"] : null), "errorMessage" => (isset($context["errorMessage"]) ? $context["errorMessage"] : null))));
        // line 36
        echo "      ";
        // line 37
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_import.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 37)->display(array_merge($context, array("level" => (isset($context["level"]) ? $context["level"] : null), "errorMessage" => (isset($context["errorMessage"]) ? $context["errorMessage"] : null))));
        // line 38
        echo "      ";
        // line 39
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/menu_top.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 39)->display(array_merge($context, array("topMenuData" => (isset($context["topMenuData"]) ? $context["topMenuData"] : null), "bulkActions" => (isset($context["bulkActions"]) ? $context["bulkActions"] : null))));
        // line 40
        echo "
      ";
        // line 41
...
";
    ...
    public function block_catalog_categories_listing($context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["categories"]) ? $context["categories"] : null), "subMenu", array()));
        $context['loop'] = array(
    ...
    public function block_addon_card_see_more($context, array $blocks = array())
    {
        // line 54
        echo "                ";
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "modules", array())) > (isset($context["maxModulesDisplayed"]) ? $context["maxModulesDisplayed"] : null))) {
            // line 55
            echo "                  ";
            $this->loadTemplate("@PrestaShop/Admin/Module/Includes/see_more.html.twig", "@PrestaShop/Admin/Module/manage.html.twig", 55)->display(array_merge($context, array("id" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "refMenu", array()))));
            // line 56
            echo "                ";
        }
        // line 57
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Module/manage.html.twig", "/home/padilo00/padilo.pro/presta/src/PrestaShopBundle/Resources/views/Admin/Module/manage.html.twig");
    }
}
