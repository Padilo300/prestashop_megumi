...
<div id="search_widget" class="mf-header__finder" data-search-controller-url="{$search_controller_url}">
	<form action="{$search_controller_url}" method="post" >
		<input type="hidden" name="controller" value="search">
		<fieldset class="mf-header__finder-input-box">
			<input type="text" class="mf-header__finder-input" name="s" value="{$search_string}" placeholder="{l s='Search' d='Shop.Theme.Catalog'}" aria-label="{l s='Search' d='Shop.Theme.Catalog'}" >
		</fieldset>
