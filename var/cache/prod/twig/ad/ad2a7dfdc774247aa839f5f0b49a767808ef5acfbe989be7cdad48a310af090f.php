...
class __TwigTemplate_8292074ab32d94d66b3fa4979cfe3843467e4e5d78145d63d319038e7c0556f7 extends Twig_Template
{
      ...
      <div class=\"card-text\">
        ...
        echo "
          <div class=\"col-sm\">
            ";
        // line 39
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["metaForm"]) ? $context["metaForm"] : null), "seo_options", array()), "product_attributes_in_title", array()), 'errors');
        echo "
            ";
        // line 40
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["metaForm"]) ? $context["metaForm"] : null), "seo_options", array()), "product_attributes_in_title", array()), 'widget');
        echo "
          </div>
        </div>
...
";
    ...
    public function block_meta_form_rest($context, array $blocks = array())
    {
        // line 45
        echo "          ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["metaForm"]) ? $context["metaForm"] : null), "seo_options", array()), 'rest');
        echo "
        ";
    }
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Configure/ShopParameters/TrafficSeo/Meta/Blocks/seo_options_configuration.html.twig", "/home/padilo00/padilo.pro/presta/src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters/TrafficSeo/Meta/Blocks/seo_options_configuration.html.twig");
    }
}
