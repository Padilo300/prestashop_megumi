...
class ProductComments extends Module
{
    ...
    protected function _postProcess()
    {
        ...
        $this->_clearcache('mypresta_productcomments_reviews_list.tpl');
    }
    ...
    public function renderConfigForm()
    {
        ...
        $this->context->controller->informations[] = $this->l('Do you know that module has page with all added comments? ') . '<strong><a href="' . $this->context->link->getModuleLink('productcomments', 'feedback') . '">' . $this->l('Check it here') . '</a></strong>';
    ...
    public function hookDisplayProductListReviews($params)
    {
        ...
        if (!$this->isCached('module:productcomments/mypresta_productcomments_reviews_list.tpl', $this->getCacheId($id_product.'-list'))) {
        ...
        return $this->fetch('module:productcomments/mypresta_productcomments_reviews_list.tpl', $this->getCacheId($id_product.'-list'));
    }
    ...
    public function hookProductFooter($params)
    {
        ...
        return $this->display(__FILE__, '/mypresta_productcomments.tpl');
    }
