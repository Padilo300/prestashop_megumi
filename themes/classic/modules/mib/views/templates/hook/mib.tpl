            ...
            <div class="mg-main-slider-brends">
                {foreach from=$manufacturers item=manufacturer name=manufacturer_list}
                    {if $manufacturer.image}
                        ...
                        <div>
                            <a class="mg-main-slider-brends__item" href="{Context::getContext()->link->getmanufacturerLink($manufacturer.id_manufacturer, $manufacturer.link_rewrite)|escape:'html'} title="{l s='More about %s' sprintf=[$manufacturer.name] mod='mib'}"">
