...
class __TwigTemplate_e02c0c807afdc27f45178c0c158679083669394afa652cacd8ed96bc573ee0f2 extends Twig_Template
{
...
";
    ...
    public function block_date_range_widget($context, array $blocks = array())
    {
        ...
        // line 307
        echo "    ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "from", array()), 'widget');
        echo "
    ";
        // line 308
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "to", array()), 'widget');
        echo "
  ";
        echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
    }
    ...
    public function block_search_and_reset_widget($context, array $blocks = array())
    {
        ...
        if ((isset($context["show_reset_button"]) ? $context["show_reset_button"] : null)) {
            ...
            echo "[reset]\"
                    ...
                    data-url=\"";
            // line 327
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "vars", array()), "attr", array()), "data-url", array(), "array"), "html", null, true);
            echo "\"
                    data-redirect=\"";
            // line 328
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "vars", array()), "attr", array()), "data-redirect", array(), "array"), "html", null, true);
            echo "\"
            >
...
$context["error"], "messageTemplate", array()), $this->getAttribute($context["error"], "messagePluralization", array()), $this->getAttribute($context["error"], "messageParameters", array()), "form_error"))), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["choice_name"] => $context["choice_value"]) {
            ...
            foreach ($context['_seq'] as $context["child_choice_name"] => $context["child_choice"]) {
                ...
                if ($this->getAttribute($this->getAttribute((isset($context["child_choice_entry_index_mapping"]) ? $context["child_choice_entry_index_mapping"] : null), $context["choice_value"], array(), "array", false, true), $context["child_choice_name"], array(), "array", true, true)) {
                    // line 580
                    echo "                  ";
                    $context["entry_index"] = $this->getAttribute($this->getAttribute((isset($context["child_choice_entry_index_mapping"]) ? $context["child_choice_entry_index_mapping"] : null), $context["choice_value"], array(), "array"), $context["child_choice_name"], array(), "array");
                    // line 581
                    echo "
                  ";
                    // line 582
                    if ($this->getAttribute($this->getAttribute($context["child_choice"], "vars", array()), "multiple", array())) {
                        // line 583
                        echo "                    ";
                        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($context["child_choice"], (isset($context["entry_index"]) ? $context["entry_index"] : null), array(), "array"), 'widget', array("material_design" => true));
                        echo "
                  ";
                    } else {
                        // line 585
                        echo "                    ";
                        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($context["child_choice"], (isset($context["entry_index"]) ? $context["entry_index"] : null), array(), "array"), 'widget');
                        echo "
                  ";
                    }
                    // line 587
  ...
  ";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/TwigTemplateForm/bootstrap_4_layout.html.twig", "/home/padilo00/padilo.pro/presta/src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm/bootstrap_4_layout.html.twig");
    }
}
