                ...
                <div>
                    <div class="mg-main-category__item">
                        <a href="{$categoryLink}" title="{$category->name|escape:html:'UTF-8'}">
                            ...
                            {else}
                                <img src="{$urls.img_cat_url|escape:'html':'UTF-8'}{$language.iso_code|escape:'html':'UTF-8'}.jpg"  title="{l s='No image' mod='homecategoriez'}"  alt="{$category->name|escape:html:'UTF-8'}">
                            {/if}
                            <span>{$category->name|truncate:42:'...'|escape:'htmlall':'UTF-8'}</span>
                        </a>
                    </div>
                </div>
...
{*        <a class="mg-btn" href="#">Смотреть все</a>*}
    </div>
</section>
