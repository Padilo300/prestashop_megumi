...
class __TwigTemplate_b49cbbd4ea57abe38e8def96fd0abfcac4bb460d243af2e608ae7a93b020f669 extends Twig_Template
{
...
";
    ...
    public function getform_label_tooltip($__name__ = null, $__tooltip__ = null, $__placement__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 26
            echo "    ";
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["name"]) ? $context["name"] : null), 'label', array("label_attr" => array("tooltip" => (isset($context["tooltip"]) ? $context["tooltip"] : null), "tooltip_placement" => (((isset($context["placement"]) || array_key_exists("placement", $context))) ? (_twig_default_filter((isset($context["placement"]) ? $context["placement"] : null), "top")) : ("top")))));
            echo "
";
        } catch (Exception $e) {
            ob_end_clean();
...
";
    ...
    public function getsortable_column_header($__title__ = null, $__sortColumnName__ = null, $__orderBy__ = null, $__sortOrder__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 69
            echo "  ";
            list($context["sortOrder"], $context["orderBy"]) =             array((((isset($context["sortOrder"]) || array_key_exists("sortOrder", $context))) ? (_twig_default_filter((isset($context["sortOrder"]) ? $context["sortOrder"] : null), "")) : ("")), (((isset($context["orderBy"]) || array_key_exists("orderBy", $context))) ? (_twig_default_filter((isset($context["orderBy"]) ? $context["orderBy"] : null), "")) : ("")));
            // line 70
            echo "    <div
...
";
    ...
    public function getimport_file_sample($__label__ = null, $__filename__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_import_sample_download", array("sampleName" => (isset($context["filename"]) ? $context["filename"] : null))), "html", null, true);
            echo "\">
        ";
            // line 87
...
";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/macros.html.twig", "/home/padilo00/padilo.pro/presta/src/PrestaShopBundle/Resources/views/Admin/macros.html.twig");
    }
}
