...
class __TwigTemplate_a860c7c4d37ce232c8a8ff71bbc89cc0840326dcb68b80d65e281083648bef48 extends Twig_Template
{
...
";
    ...
    <div class=\"showcase-card__right\">
      ...
      ";
            ...
            if (((isset($context["indexPageId"]) ? $context["indexPageId"] : null) && (isset($context["isGridDisplayed"]) ? $context["isGridDisplayed"] : null))) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_metas_edit", array("metaId" => (isset($context["indexPageId"]) ? $context["indexPageId"] : null))), "html", null, true);
                echo "\">";
  ...
  ";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Configure/ShopParameters/TrafficSeo/Meta/Blocks/meta_showcase_card.html.twig", "/home/padilo00/padilo.pro/presta/src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters/TrafficSeo/Meta/Blocks/meta_showcase_card.html.twig");
    }
}
