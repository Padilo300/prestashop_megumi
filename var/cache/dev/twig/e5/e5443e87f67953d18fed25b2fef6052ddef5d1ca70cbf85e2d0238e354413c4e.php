...
class __TwigTemplate_0405584c016fa075a4bd2d990a34a40a406e7c3b3f678553d961b436ce34016d extends Twig_Template
{
...
";
        // line 26
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["grid"]) ? $context["grid"] : $this->getContext($context, "grid")), "filter_form", array())) > 1)) {
            // line 27
            echo "  <tr class=\"column-filters ";
            if (((0 == $this->getAttribute($this->getAttribute((isset($context["grid"]) ? $context["grid"] : $this->getContext($context, "grid")), "data", array()), "records_total", array())) && twig_test_empty($this->getAttribute((isset($context["grid"]) ? $context["grid"] : $this->getContext($context, "grid")), "filters", array())))) {
                echo "d-none";
            }
            echo "\">
    ";
        ...
        ";
                ...
                if ($this->getAttribute($this->getAttribute((isset($context["grid"]) ? $context["grid"] : null), "column_filters", array(), "any", false, true), $this->getAttribute($context["column"], "id", array()), array(), "array", true, true)) {
                    ...
                    echo "          ";
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["grid"]) ? $context["grid"] : $this->getContext($context, "grid")), "column_filters", array()), $this->getAttribute($context["column"], "id", array()), array(), "array"));
                    foreach ($context['_seq'] as $context["_key"] => $context["filter_name"]) {
                        // line 32
                        echo "            ";
                        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["grid"]) ? $context["grid"] : $this->getContext($context, "grid")), "filter_form", array()), $context["filter_name"], array(), "array"), 'widget');
                        echo "
          ";
                    }
...
{% endif %}
", "@PrestaShop/Admin/Common/Grid/Blocks/Table/filters_row.html.twig", "/home/padilo00/padilo.pro/presta/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/Blocks/Table/filters_row.html.twig");
    }
}
