...
/**
 * Class CDEKOrdersPrint
 * @see Печатная форма квитанции к заказу
 */
class CDEKOrdersPrint extends CDEKDocument
{
	protected $order;
	...
	{
		$this->order = $order;
		$this->api_path = self::API_URL.'orders_print.php';
		$this->root_name = 'OrdersPrint';
	...
	protected function parseResponse($response)
	{
		...
		header('Content-Disposition: attachment; filename=order_'.$this->order->id.'.pdf');
		return $response;
	}
