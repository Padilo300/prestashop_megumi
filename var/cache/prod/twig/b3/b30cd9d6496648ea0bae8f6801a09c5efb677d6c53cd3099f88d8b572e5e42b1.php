...
class __TwigTemplate_624dbcf08afd78fd0579acfd1eec30a41a89c5532ebe263cfbd4c42e7f224c8f extends Twig_Template
{
...
";
    ...
    public function block_catalog_category_empty($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "refMenu", array()), "html", null, true);
        echo "\">
    <p>
      ";
        // line 29
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("You do not have module in « %categoryName% ».", array("%categoryName%" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "name", array())), "Admin.Modules.Feature"), "html", null, true);
        echo "<br/>
      ";
        // line 30
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Discover the best-selling modules of this category in the %link% page.", array("%link%" => (((((("<a href=\"" . $this->env->getExtension('PrestaShopBundle\Twig\LayoutExtension')->getAdminLink("AdminPsMboModule", true)) . "&filterCategoryTab=") . $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "refMenu", array())) . "\">") . $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "name", array())) . "</a>")), "Admin.Modules.Feature");
        echo "
    </p>
  </div>
";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Module/Includes/grid_manage_empty.html.twig", "/home/padilo00/padilo.pro/presta/modules/ps_mbo/views/PrestaShop/Admin/Module/Includes/grid_manage_empty.html.twig");
    }
}
