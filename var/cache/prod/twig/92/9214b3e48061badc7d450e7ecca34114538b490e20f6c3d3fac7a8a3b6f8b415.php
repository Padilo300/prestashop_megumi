...
class __TwigTemplate_83f8bd59f48a82122fc52daa80af945927d33e9d75029200277781a0131465f4 extends Twig_Template
{
...
";
    ...
    public function block_grid_panel_header($context, array $blocks = array())
    {
        ...
        ";
        // line 29
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["grid"]) ? $context["grid"] : null), "name", array()), "html", null, true);
        echo " (";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["grid"]) ? $context["grid"] : null), "data", array()), "records_total", array()), "html", null, true);
        echo ")
    </h3>
  ";
    }
  ...
  ";
    ...
    public function block_grid_view_block($context, array $blocks = array())
    {
        // line 36
        echo "        ";
        echo twig_include($this->env, $context, "@PrestaShop/Admin/Common/Grid/grid.html.twig", array("grid" => (isset($context["grid"]) ? $context["grid"] : null)));
        echo "
      ";
    }
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Common/Grid/grid_panel.html.twig", "/home/padilo00/padilo.pro/presta/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/grid_panel.html.twig");
    }
}
